			...
			synchronized (windowCache)
			{
				...
				if (cache != null)
				{
					...
					if (mWindowVO != null)
					{
						...
						//	Yamel Senih 2014-05-12, 16:59:54
						//	Grant Access
						// Ensure ASP exceptions
						MRole role = MRole.getDefault(Env.getCtx(), false);
						final Boolean windowAccess = role.getWindowAccess(mWindowVO.AD_Window_ID);
						if (mWindowVO != null && windowAccess == null)
							mWindowVO = null;		//	Not found
						if (mWindowVO != null && windowAccess != null)
							mWindowVO.IsReadWrite = (windowAccess.booleanValue() ? "Y" : "N");
						//	End Yamel Senih
					}
				}
			}
