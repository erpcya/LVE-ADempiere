...
public class X_LVE_WH_UserDocSequence extends PO implements I_LVE_WH_UserDocSequence, I_Persistent 
{
	...
	/** Set Print Set Control No.
		@param IsPrintSetControlNo Print Set Control No	  */
	public void setIsPrintSetControlNo (boolean IsPrintSetControlNo)
	{
		set_Value (COLUMNNAME_IsPrintSetControlNo, Boolean.valueOf(IsPrintSetControlNo));
	}

	/** Get Print Set Control No.
		@return Print Set Control No	  */
	public boolean isPrintSetControlNo () 
	{
		Object oo = get_Value(COLUMNNAME_IsPrintSetControlNo);
		if (oo != null) 
		{
