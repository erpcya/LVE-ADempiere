...
public class MDDOrder extends X_DD_Order implements DocAction
{
	...
	{
		//	Dixon Martinez 2014-12-11
		//	Add support Releasing amount reserved to  void order of distribution
		//	Is Action Void
		boolean isActionVoid = false;
		...
		for (MDDOrderLine line : lines)
		{
			...
			//	Binding
			BigDecimal target = isActionVoid ? Env.ZERO : line.getQtyOrdered(); 
			BigDecimal reserved_ordered = target
				.subtract(line.getQtyReserved())
				.subtract(line.getQtyDelivered()); 
