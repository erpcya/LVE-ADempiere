...
//	private int             m_AD_Color_ID = 0;
	...
	{
		return Msg.translate(Env.getCtx(), "AD_Color_ID");
	}   //  getDisplay
	...
	public void actionPerformed (ActionEvent e)
	{
		...
		m_cc = cc;
		//	
		//setBackground(false);		//	set Button
		//	End Yamel Senih
		...
		else if (cc.isGradient())
		{
			...
			m_mTab.setValue("RepeatDistance",   new Integer(cc.getGradientRepeatDistance()));
	...
	{
		String add = primary ? "" : "_1";
		m_mTab.setValue("Red" + add,    new Integer(c.getRed()));
		m_mTab.setValue("Green" + add,  new Integer(c.getGreen()));
		m_mTab.setValue("Blue" + add,   new Integer(c.getBlue()));
	}   //  setColor
