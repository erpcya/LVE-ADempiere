...
public final class FactLine extends X_Fact_Acct
{
	...
	/** Carlos Parada Filter Debit Or Credit **/
	/**************************************************************************
	...
	{
		return updateReverseLine (AD_Table_ID, Record_ID, Line_ID,
				multiplier,null);
	}
	 ...
	 */
	public boolean updateReverseLine (int AD_Table_ID, int Record_ID, int Line_ID,
		BigDecimal multiplier,String CreditDebit)
	{
		...
		/** Carlos Parada Filter Debit Or Credit **/
		if (CreditDebit!=null){
			if (CreditDebit.equals("D"))
				sql += " AND AmtAcctCr = 0 ";
			else if (CreditDebit.equals("C"))
				sql += " AND AmtAcctDr = 0 ";
		}
		// MZ Goodwill
		// for Inventory Move
