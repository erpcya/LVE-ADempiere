			...
			for (int i = 0; i < p_lines.length; i++)
			{
						...
						&& m_Reversal_ID !=0 && line.getReversalLine_ID() != 0)
				{
					...
					if (!dr.updateReverseLine (MInOut.Table_ID, 
							/** 2014-04-05 Carlos Parada Filter Debit Or Credit **/
							m_Reversal_ID, line.getReversalLine_ID(),Env.ONE,"D"))
					{
						...
						&& m_Reversal_ID !=0 && line.getReversalLine_ID() != 0)
				{
					...
					if (!cr.updateReverseLine (MInOut.Table_ID, 
							/** 2014-04-05 Carlos Parada Filter Debit Or Credit **/
							m_Reversal_ID, line.getReversalLine_ID(),Env.ONE,"C"))
					{
						p_Error = "Original Shipment/Receipt not posted yet";
						return null;
					}
				...
				if (line.getM_Product_ID() != 0)
				{
					MCostDetail.createShipment(as, line.getAD_Org_ID(), 
						...
						line.get_ID(), 0,
						//2014-02-03 Carlos Parada Set Cost to ABS 
						costs.abs()
						//End Carlos Parada
						, line.getQty(),
