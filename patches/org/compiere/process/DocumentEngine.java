	...
	public boolean processIt (String processAction, String docAction)
	{
		...
		else
		{
			throw new IllegalStateException("@InvalidAction@: "
				+ "@ProcessAction@="  + MRefList.getListName(getCtx(), DocAction.AD_REFERENCE_ID, processAction) 
				+ ", @DocAction@=" + MRefList.getListName(getCtx(), DocAction.AD_REFERENCE_ID, docAction)
