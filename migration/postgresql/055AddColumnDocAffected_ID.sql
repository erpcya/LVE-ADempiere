...
-- LVE Withholding
INSERT INTO AD_Val_Rule (AD_Client_ID,AD_Org_ID,AD_Val_Rule_ID,Code,Created,CreatedBy,EntityType,IsActive,Name,Type,Updated,UpdatedBy) VALUES (0,0,52280,'C_Invoice.C_BPartner_ID=@C_BPartner_ID@ AND C_Invoice.IsPaid=''N'' AND IsSOTrx = ''@IsSOTrx@'' AND DocBaseType IN (SELECT DocBaseType FROM C_DocType WHERE C_Invoice.C_DocTypeTarget_ID = C_DocType.C_DocType_ID WHERE DocBaseType IN (''API'',''ARI''))',TO_TIMESTAMP('2013-12-12 20:31:20','YYYY-MM-DD HH24:MI:SS'),100,'ECA02','Y','C_Invoice of C_BPartner and Not Paid','S',TO_TIMESTAMP('2013-12-12 20:31:20','YYYY-MM-DD HH24:MI:SS'),100)
;
...
-- LVE-Withholding
UPDATE AD_Val_Rule SET Code='C_Invoice.C_BPartner_ID= @C_BPartner_ID@ AND C_Invoice.IsPaid=''N'' AND DocStatus IN (''CO'') AND IsSOTrx = ''@IsSOTrx@'' AND C_DocTypeTarget_ID <> @C_DocTypeTarget_ID@',Updated=TO_TIMESTAMP('2014-11-27 16:21:50','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Val_Rule_ID=52280
;
...
UPDATE AD_Val_Rule SET Code='C_Invoice.C_BPartner_ID= @C_BPartner_ID@ 
	...
	AND DocAffected_ID IS NULL',Updated=TO_TIMESTAMP('2014-11-27 18:14:04','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Val_Rule_ID=52280
;

-- Nov 27, 2014 8:15:09 PM VET
-- LVE-Withholding
UPDATE AD_Val_Rule SET Code='C_Invoice.C_BPartner_ID= @C_BPartner_ID@ AND DocStatus IN (''CO'') AND IsSOTrx = ''@IsSOTrx@'' AND C_DocTypeTarget_ID <> @C_DocTypeTarget_ID@ AND DocAffected_ID IS NULL',Updated=TO_TIMESTAMP('2014-11-27 20:15:09','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Val_Rule_ID=52280
;
