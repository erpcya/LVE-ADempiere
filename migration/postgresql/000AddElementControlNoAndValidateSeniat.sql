...
-- LVE Withholding
INSERT INTO AD_Element (AD_Client_ID,AD_Element_ID,AD_Org_ID,ColumnName,Created,CreatedBy,EntityType,IsActive,Name,PrintName,Updated,UpdatedBy) VALUES (0,56121,0,'ValidateSeniat',TO_TIMESTAMP('2013-08-16 12:01:02','YYYY-MM-DD HH24:MI:SS'),100,'ECA02','Y','Validate Seniat','Validate Seniat',TO_TIMESTAMP('2013-08-16 12:01:02','YYYY-MM-DD HH24:MI:SS'),100)
;
...
-- LVE Withholding
UPDATE AD_Element_Trl SET Name='Validar R.I.F. Seniat',PrintName='Validar R.I.F. Seniat',Updated=TO_TIMESTAMP('2013-08-16 12:01:13','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Element_ID=56121 AND AD_Language='es_MX'
;
