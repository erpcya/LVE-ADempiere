...
-- I forgot to set the DICTIONARY_ID_COMMENTS System Configurator
INSERT INTO AD_Field (AD_Client_ID,AD_Column_ID,AD_Field_ID,AD_Org_ID,AD_Tab_ID,Created,CreatedBy,Description,DisplayLength,EntityType,Help,IsActive,IsCentrallyMaintained,IsDisplayed,IsEncrypted,IsFieldOnly,IsHeading,IsReadOnly,IsSameLine,Name,Updated,UpdatedBy) VALUES (0,3000255,3000449,0,186,TO_TIMESTAMP('2014-06-26 16:15:16','YYYY-MM-DD HH24:MI:SS'),100,'Is the Payment Schedule is valid',1,'ECA02','Payment Schedules allow to have multiple due dates.','Y','Y','Y','N','N','N','N','N','Pay Schedule valid',TO_TIMESTAMP('2014-06-26 16:15:16','YYYY-MM-DD HH24:MI:SS'),100)
;
...
-- I forgot to set the DICTIONARY_ID_COMMENTS System Configurator
ALTER TABLE AD_Field ADD COLUMN IsAllowsCopy CHAR(1) DEFAULT NULL CHECK (IsAllowsCopy IN ('Y','N'))
;
